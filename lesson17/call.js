...
const withName = greeting;
// companywithName.call(company.companyName);// wrong
withName.call(company, 'Bob', 'Marley');
...
const popul = getPopulation;
console.log(popul.call(country, +43000));
...
const diff = transaction.printTransaction;
diff.call(anotherTransaction);
